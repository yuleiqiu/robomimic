"""LAN-O3DP inference with swept-ellipsoid predicted-clean guidance."""
...
@register_algo_factory_func("ellipsoid_guided_lan_o3dp")
def algo_config_to_class(algo_config):
    if algo_config.unet.enabled:
        return EllipsoidGuidedLanO3DPUNet, {}
    if algo_config.transformer.enabled:
        raise NotImplementedError()
    raise RuntimeError()


class EllipsoidGuidedLanO3DPUNet(LanO3DPUNet):
    """Guide predicted executable absolute-EEF poses using rigid ellipsoids."""
